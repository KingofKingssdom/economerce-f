...
function LaptopProduct() {
        ...
        useEffect(() => {
            const fetchBrand = async () => {
                try {
                    const response = await axios.get("http://localhost:8080/brand/category?categoryId=3");
    ...
    const handleBrand = async (selectedBrandId) => {
        ...
        try {
            const response = await axios.get(`http://localhost:8080/product/category/brand?categoryId=3&brandId=${selectedBrandId}`);
            setLaptops(response.data);
        } catch (error) {
    ...
    const handleSelectFilter = async (filterType) => {
        ...
        if (filterType === "highToLow") {
            url += brandId ? `category/brand/price/desc?categoryId=3&brandId=${brandId}` : `category/price/desc?categoryId=3`;
        } else if (filterType === "lowToHigh") {
            url += brandId ? `category/brand/price/asc?categoryId=3&brandId=${brandId}` : `category/price/asc?categoryId=3`;
        }
        ...
        <>
            ...
            <div className="banner-detail">
                ...
                <div className="carousel-inner">
                    ...
                    <img src="./image/laptopBanner1.webp" className="d-block w-100" alt="..."/>
                    </div>
                    <div className="carousel-item" data-bs-interval="2000">
                    <img src="./image/laptopBanner2.webp" className="d-block w-100" alt="..."/>
                    </div>
                    <div className="carousel-item">
                    <img src="./image/laptopBanner3.webp" className="d-block w-100" alt="..."/>
                    </div>
                    <div className="carousel-item">
                    <img src="./image/laptopBanner4.webp" className="d-block w-100" alt="..."/>
                    </div>
                </div>
                ...
                <div className="carousel-inner">
                    <div className="carousel-item active" data-bs-interval="10000">
                    <img src="./image/laptopBanner5.webp" className="d-block w-100" alt="..."/>
                    </div>
                    <div className="carousel-item" data-bs-interval="2000">
                    <img src="./image/laptopBanner6.webp" className="d-block w-100" alt="..."/>
                    </div>
                    <div className="carousel-item">
                    <img src="./image/laptopBanner7.webp" className="d-block w-100" alt="..."/>
                    </div>
                    <div className="carousel-item">
                    <img src="./image/laptopBanner8.webp" className="d-block w-100" alt="..."/>
                    </div>
                </div>
